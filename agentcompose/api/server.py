"""FastAPI server factory for AgentCompose."""
...
from agentcompose.config.models import Config, ServingConfig
from agentcompose.api.routes import health, agents, chat, openai_compat, tasks, langgraph_studio, conversations, landing
...
def create_app(
    ...
    Args:
        config: Full AgentCompose configuration.
    ...
    app = FastAPI(
        title="AgentCompose - Multi-Agent Orchestration System",
...
async def default_lifespan(app: FastAPI):
    ...
    """
    logger.info("agentcompose_starting")
    yield
    logger.info("agentcompose_shutting_down")
