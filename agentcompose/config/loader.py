"""Configuration loader for AgentCompose."""
...
class ConfigLoader:
    ...
    def __init__(self, env_prefix: str = "AgentCompose_"):
        """
    ...
    def _apply_env_overrides(self, config_dict: Dict[str, Any]) -> Dict[str, Any]:
        ...
        - AgentCompose_SERVING_API_HOST -> serving.api.host
        - AgentCompose_GRAPH_MAX_ITERATIONS -> graph.max_iterations
...
def load_config(config_path: Optional[str] = None) -> Config:
    ...
    Args:
        config_path: Path to config file. If None, looks for:
            1. AgentCompose_CONFIG environment variable
    ...
    env_path = os.environ.get("AgentCompose_CONFIG")
    if env_path:
