...
class LLMFactory:
    ...
    def create(self, config: LLMConfig) -> LLMAdapter:
        ...
        """
        from agentcompose.llm.adapters.langchain_adapter import create_adapter_from_config
    ...
    def create_chat_model(self, config: LLMConfig) -> BaseChatModel:
        ...
        """
        from agentcompose.llm.adapters.langchain_adapter import create_langchain_model
