...
from agentcompose.config.models import Config, GraphConfig
from agentcompose.agents.registry import AgentRegistry
from agentcompose.agents.models import ExternalAgent
...
class GraphFactory:
    ...
    def _convert_to_langchain_tool(self, tool) -> BaseTool:
        """Convert a AgentCompose tool to a LangChain tool."""
