...
allowing AgentWeave to be used with the LangGraph Studio UI for visualization,
...
def _init_default_assistant(context: Dict[str, Any]) -> None:
    """Initialize default assistant from AgentWeave config."""
    ...
    _assistants["default"] = Assistant(
        ...
        graph_id="agentweave",
        name="AgentWeave Default Assistant",
