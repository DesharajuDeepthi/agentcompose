"""Pydantic models for AgentWeave configuration."""
...
class CheckpointerConfig(BaseModel):
    ...
    # SQLite settings
    sqlite_path: str = Field(default="agentweave_checkpoints.db", description="Path to SQLite database file")
    # PostgreSQL settings
...
class Config(BaseModel):
    """Root configuration model for AgentWeave."""
